...
/* Logic for the drop down menu which toggles independently of other menus */
...
/* Form validation to check if email address is wrongly formatted before submitting. Returns error message when not formatted correctly */
